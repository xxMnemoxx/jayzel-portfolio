...
const Hero = () => {
  return (
    <section id="about" className="relative py-20 lg:py-28">
      <div className="game-panel relative overflow-hidden rounded-lg p-5 md:p-8 lg:p-10">
        <div className="relative grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="flex flex-col items-center gap-6 lg:items-end">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://github.com/xxMnemoxx" target="_blank" rel="noreferrer" className="group flex items-center gap-2 text-stone-300 transition-colors hover:text-cyan-200" title="GitHub">
